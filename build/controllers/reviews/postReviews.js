...
const postReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const imagesArray = [];
        files === null || files === void 0 ? void 0 : files.image.map((file) => {
            imagesArray.push(file === null || file === void 0 ? void 0 : file.location);
        });
        const review = yield reviews_1.Review.create({
            title,
            rating,
            comment,
            user: userId,
        ...
        logger_1.logger.info('review posted successfully: ', review);
    }
    catch (error) {
